...
app.get("/send-notification/:id", async (req, res) => {
  ...
  console.log(subscriptionsForUser[0].subscription);

  // // This is the same output of calling JSON.stringify on a PushSubscription
  // const pushSubscription = {
  //   endpoint: subscriptionsForUser[0].subscription.endpoint,
  //   keys: {
  //     auth: subscriptionsForUser[0].subscription.keys.auth,
  //     p256dh: subscriptionsForUser[0].subscription.keys.p256dh
  //   }
  // };
